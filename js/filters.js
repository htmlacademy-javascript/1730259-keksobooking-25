import {filterHouse, filterPrice, filterRooms, filterGuests, /*filterFeatures*/} from './reset-form.js';
...
const chooseHouses = (element) => filterHouse.value === 'any' ? true: element.offer.type === filterHouse.value;
const chooseRooms = (element) => filterRooms.value === 'any' ? true: element.offer.rooms === filterRooms.value;
const chooseGuests = (element) => filterGuests.value === 'any' ? true: element.offer.guests === filterGuests.value;
